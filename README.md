...
![看板运行实况](docs/img/dashboard_canvas.png)

*看板运行实况（真实仿真数据渲染）：龙门双轴定位曲线、实时同步偏差 Δ(t)、256 点凸轮表（分段着色）、飞剪速度曲线（切割 5 刀/速度误差均值 0.65 mm/s/节拍 857 ms）与输送带-切刀联动 Canvas 动画。*
